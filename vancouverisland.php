<?php 
    ...
    $trip_id = 6; // replace this with the actual trip ID
...
<head>
    ...
    <title>Vancouver Island Trip Information</title>
</head>
                ...
                <div id="tripImgs" class="carousel slide" data-bs-ride="carousel">
                    ...
                    <div class="carousel-inner">
                        <div class="carousel-item active c-item">
                            <img src="img/VancouverIsland.jpg" class="d-block w-100 c-img" alt="Trip Image">
                        </div>
                        <div class="carousel-item c-item">
                            <img src="img/vancouverIsland2.jpg" class="d-block w-100 c-img" alt="Trip Image">
                        </div>
                        <div class="carousel-item c-item">
                            <img src="img/vancouverIsland3.jpg" class="d-block w-100 c-img" alt="Trip Image">
                        </div>
                    </div>
    ...
    <section class="bg-white text-dark p-3 text-left">
        <div class="container">
            <div class="d-md-flex flex-column justify-content-between align-items-center">
                ...
                <p>A bus trip around Vancouver Island is an excellent way to explore the stunning natural 
                    beauty of British Columbia's west coast. The journey takes you through charming seaside towns, 
                    rugged coastal landscapes, and ancient forests. You'll have the chance to spot wildlife like whales, eagles, 
                    and bears, and enjoy activities such as hiking, kayaking, and fishing. Stops along the way can include the quaint 
                    fishing village of Ucluelet, the surf town of Tofino, and the picturesque capital city of Victoria. The bus trip offers 
                    a convenient and comfortable way to experience the best of Vancouver Island's rugged west coast.</p>
                <ul>
                    <li>Country: Canada</li>
                    <li>Duration (days): 6</li>
                    <li>Price per Ticket (CAD): $500.00</li>
                </ul>
                <form action="booking.php" method="GET" target="_self">
                    <div class="mb-3">
                        <input type="hidden" name="tripName" value="Vancouver Island" />
                        <input type="hidden" name="country" value="Canada" />
                        <input type="hidden" name="duration" value="6" />
                        <input type="hidden" name="ticketPrice" value="500.00" />
                        <input type="hidden" name="tripId"  value ="6"/>
                    </div>

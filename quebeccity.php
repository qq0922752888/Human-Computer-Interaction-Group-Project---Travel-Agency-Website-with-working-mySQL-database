<?php 
    ...
    $trip_id = 8; // replace this with the actual trip ID
...
<head>
    ...
    <title>Quebec City Trip Information</title>
</head>
                ...
                <div id="tripImgs" class="carousel slide" data-bs-ride="carousel">
                    ...
                    <div class="carousel-inner">
                        <div class="carousel-item active c-item">
                            <img src="img/Quebec.jpg" class="d-block w-100 c-img" alt="Trip Image">
                        </div>
                        <div class="carousel-item c-item">
                            <img src="img/Quebec2.jpg" class="d-block w-100 c-img" alt="Trip Image">
                        </div>
                        <div class="carousel-item c-item">
                            <img src="img/Quebec3.jpg" class="d-block w-100 c-img" alt="Trip Image">
                        </div>
                    </div>
    ...
    <section class="bg-white text-dark p-3 text-left">
        <div class="container">
            <div class="d-md-flex flex-column justify-content-between align-items-center">
                ...
                <p>Steeped in history and culture, Quebec City is a charming and picturesque destination in eastern Canada. The city is located on the banks of the St. Lawrence River 
                    and is famous for its beautiful old town, which is a UNESCO World Heritage Site. The cobblestone streets, historic buildings, and charming cafes and restaurants 
                    create a unique atmosphere that transports visitors back in time. There are numerous landmarks to explore, including the iconic Chateau Frontenac, the Citadel, and 
                    the Plains of Abraham. The city is also known for its delicious food and drink, with plenty of opportunities to sample traditional Quebecois cuisine and local wines and beers. 
                    Throughout the year, the city hosts numerous festivals and events, including the Winter Carnival and the Festival d'été de Québec, which showcases a range of music and arts performances. 
                    Whether you're strolling through the picturesque streets, enjoying the vibrant cultural scene, or simply soaking up the historic atmosphere, Quebec City is a must-visit destination for 
                    anyone traveling to eastern Canada.</p>
                <ul>
                ...
                <form action="booking.php" method="GET" target="_self">
                    <div class="mb-3">
                        <input type="hidden" name="tripName" value="Quebec City" />
                        ...
                        <input type="hidden" name="tripId"  value ="8"/>
                    </div>
